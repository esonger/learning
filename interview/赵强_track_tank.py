...
输出结果如下
    ...
    ---- 初始化坦克数据 -----
    坦克id:4459517544, 正在向【W】方向行驶，当前坐标(x:11,y:39)
    ---- 初始化完成开始追踪 -----
    
指令:[M] 坦克id:4459517544, 正在向【W】方向行驶，当前坐标(x:10,y:39)
指令:[T] 正在时间同步
指令:[M] 坦克id:4459517544, 正在向【W】方向行驶，当前坐标(x:9,y:39)
指令:[P] 坦克向后转
指令:[R] 坦克向右转
指令:[P] 坦克向后转
指令:[M] 坦克id:4459517544, 正在向【N】方向行驶，当前坐标(x:9,y:40)
指令:[T] 正在时间同步
指令:[M] 坦克id:4459517544, 正在向【N】方向行驶，当前坐标(x:9,y:41)
指令:[L] 坦克向左转
指令:[M] 坦克id:4459517544, 正在向【W】方向行驶，当前坐标(x:8,y:41)
指令:[R] 坦克向右转
指令:[P] 坦克向后转
指令:[R] 坦克向右转
指令:[M] 坦克id:4459517544, 正在向【W】方向行驶，当前坐标(x:7,y:41)
指令:[T] 正在时间同步
指令:[P] 坦克向后转
指令:[L] 坦克向左转
指令:[M] 坦克id:4459517544, 正在向【N】方向行驶，当前坐标(x:7,y:42)
指令:[M] 坦克id:4459517544, 正在向【N】方向行驶，当前坐标(x:7,y:43)
指令:[T] 正在时间同步
指令:[L] 坦克向左转
指令:[M] 坦克id:4459517544, 正在向【W】方向行驶，当前坐标(x:6,y:43)
指令:[R] 坦克向右转
指令:[R] 坦克向右转
指令:[M] 坦克id:4459517544, 正在向【E】方向行驶，当前坐标(x:7,y:43)
指令:[P] 坦克向后转

        ---- 发射榴弹 -----
        坦克id:4459517544, 正在向【W】方向行驶，当前坐标(x:7,y:43)
        ---- 目标已击毁 -----
'''
