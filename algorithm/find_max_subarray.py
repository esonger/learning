...
def find_max_subarray2(lists, low, heigh):
    if low == heigh:
        return lists[low:heigh+1]
    mid = (heigh+low)//2
    left_sub = find_max_subarray2(lists, low, mid)
    right_sub = find_max_subarray2(lists, mid+1, heigh)
...
if __name__ == '__main__':
    ...
    l = [-2, 2, -3, 4, -1, 2, 1, -5, 3]
    print(find_max_subarray1(l))
    print(find_max_subarray2(l, 0, len(l)))
